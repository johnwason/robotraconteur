...
#define RR_EXCEPTION_TYPES_INIT(M, M2)                                                                                 \
    ...
    M(EndpointCommunicationFatalException, MessageErrorType_EndpointCommunicationFatalError,                           \
      "RobotRaconteur.EndpointCommunicationFatalError")                                                                \
    ...
    M(MessageElementNotFoundException, MessageErrorType_MessageElementNotFound,                                        \
      "RobotRaconteur.MessageElementNotFound")                                                                         \
    ...
    M(SystemResourcePermissionDeniedException, MessageErrorType_SystemResourcePermissionDenied,                        \
      "RobotRaconteur.SystemResourcePermissionDenied")                                                                 \
